...
SECRET_KEY = 'django-insecure-^s68ijv#s@_0_4x^@4=!@la%pe$o-mc=r8^st=rt(^8)5b1wuf'
...
MEDIA_URL = '/media/'  # endereço da pasta media no servidor
...
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"  # ou django.core
"""
